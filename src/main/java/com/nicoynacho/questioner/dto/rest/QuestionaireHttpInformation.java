...
public class QuestionaireHttpInformation {
	...
	public static class QuestionaireErrorBuilder extends QuestionaireInfoBuilder {
		...
		public QuestionaireErrorBuilder setException(Exception e) {
			questionaireHttpInformation.code = e instanceof QuestionerPapaException
					? ((QuestionerPapaException) e).getCode()
					: Integer.valueOf(500);
			questionaireHttpInformation.businessErrorCode = e instanceof QuestionerPapaException
					? ((QuestionerPapaException) e).getBusinessErrorCode()
					: questionaireHttpInformation.code.toString();
